...
const SearchBar = ({
  ...
  <Col className={className}>
    <Row as="section">
      ...
      <Column span={2}>
        <DatePicker date={occurredAfter === 0 ? Date.now() : occurredAfter} title="To" onChange={setOccurredAfter} />
      </Column>
    </Row>
    <Row>
      <DangerButton>Clear</DangerButton>
      <PrimaryButton onClick={fetchAction}>Apply</PrimaryButton>
    </Row>
  </Col>
);
